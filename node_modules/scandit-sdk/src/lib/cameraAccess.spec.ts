...
test.serial("adjustCamerasFromMainCameraStream", async t => {
  ...
  let cameras: Camera[] = originalCameras.map(camera => {
    return { ...camera };
  });
  t.is(CameraAccess.adjustCamerasFromMainCameraStream(<MediaStreamTrack>(<unknown>{}), cameras), undefined);
  t.is(cameras[0].cameraType, Camera.Type.BACK);
  t.is(cameras[1].cameraType, Camera.Type.FRONT);
  ...
  t.is(
    CameraAccess.adjustCamerasFromMainCameraStream(getFakeMediaStreamTrack("1", "environment", ""), cameras),
    cameras[0]
  );
  t.is(cameras[0].cameraType, Camera.Type.BACK);
  t.is(cameras[1].cameraType, Camera.Type.FRONT);
  ...
  t.is(
    CameraAccess.adjustCamerasFromMainCameraStream(getFakeMediaStreamTrack("2", "environment", ""), cameras),
    cameras[1]
  );
  t.is(cameras[0].cameraType, Camera.Type.BACK);
  t.is(cameras[1].cameraType, Camera.Type.BACK);
...
test.serial("adjustCamerasFromMainCameraStream (unknown cameras)", async t => {
  ...
  t.is(
    CameraAccess.adjustCamerasFromMainCameraStream(getFakeMediaStreamTrack("4", "environment", ""), cameras),
    cameras[0]
  );
  t.is(cameras[0].cameraType, Camera.Type.BACK);
  t.is(cameras[1].cameraType, Camera.Type.FRONT);
  ...
  t.is(
    CameraAccess.adjustCamerasFromMainCameraStream(getFakeMediaStreamTrack("5", "environment", ""), cameras),
    cameras[1]
  );
  t.is(cameras[0].cameraType, Camera.Type.FRONT);
  t.is(cameras[1].cameraType, Camera.Type.BACK);
