...
import { BarcodePickerCameraManager, ExtendedMediaTrackCapabilities } from "./barcodePickerCameraManager";
...
function fakeGetCameras(cameraAmount: number, cameraTypes?: Camera.Type[]): void {
