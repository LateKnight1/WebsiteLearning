    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                cameras = originalCameras.map(function (camera) {
                    return tslib_1.__assign({}, camera);
                });
                t.is(__1.CameraAccess.adjustCamerasFromMainCameraStream({}, cameras), undefined);
                t.is(cameras[0].cameraType, __1.Camera.Type.BACK);
                t.is(cameras[1].cameraType, __1.Camera.Type.FRONT);
                cameras = originalCameras.map(function (camera) {
                    return tslib_1.__assign({}, camera);
                });
                t.is(__1.CameraAccess.adjustCamerasFromMainCameraStream(getFakeMediaStreamTrack("1", "environment", ""), cameras), cameras[0]);
                t.is(cameras[0].cameraType, __1.Camera.Type.BACK);
                t.is(cameras[1].cameraType, __1.Camera.Type.FRONT);
                cameras = originalCameras.map(function (camera) {
                    return tslib_1.__assign({}, camera);
                });
                t.is(__1.CameraAccess.adjustCamerasFromMainCameraStream(getFakeMediaStreamTrack("2", "environment", ""), cameras), cameras[1]);
                t.is(cameras[0].cameraType, __1.Camera.Type.BACK);
                t.is(cameras[1].cameraType, __1.Camera.Type.BACK);
                cameras = originalCameras.map(function (camera) {
                    return tslib_1.__assign({}, camera);
                });
                t.is(__1.CameraAccess.adjustCamerasFromMainCameraStream(getFakeMediaStreamTrack("2", "user", ""), cameras), undefined);
                t.is(cameras[0].cameraType, __1.Camera.Type.BACK);
                t.is(cameras[1].cameraType, __1.Camera.Type.FRONT);
                return [2 /*return*/];
        }
    ...
    return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                t.is(__1.CameraAccess.adjustCamerasFromMainCameraStream(getFakeMediaStreamTrack("4", "environment", ""), cameras), cameras[0]);
                t.is(cameras[0].cameraType, __1.Camera.Type.BACK);
                t.is(cameras[1].cameraType, __1.Camera.Type.FRONT);
                cameras = originalCameras.map(function (camera) {
                    return tslib_1.__assign({}, camera);
                });
                t.is(__1.CameraAccess.adjustCamerasFromMainCameraStream(getFakeMediaStreamTrack("5", "environment", ""), cameras), cameras[1]);
                t.is(cameras[0].cameraType, __1.Camera.Type.FRONT);
                t.is(cameras[1].cameraType, __1.Camera.Type.BACK);
                cameras = originalCameras.map(function (camera) {
                    return tslib_1.__assign({}, camera);
                });
                t.is(__1.CameraAccess.adjustCamerasFromMainCameraStream(getFakeMediaStreamTrack("5", "user", ""), cameras), undefined);
                t.is(cameras[0].cameraType, __1.Camera.Type.FRONT);
                t.is(cameras[1].cameraType, __1.Camera.Type.BACK);
                return [2 /*return*/];
        }
