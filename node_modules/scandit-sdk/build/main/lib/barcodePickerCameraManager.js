                ...
                switch (_b.label) {
                    case 0:
                        this.manualToAutofocusResumeTimeout = window.setTimeout(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.triggerFocusMode("continuous")];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.triggerFocusMode("single-shot")];
                    case 2:
                        _b.sent();
                        return [3 /*break*/, 4];
                    case 3:
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(focusModeCapability instanceof Array && focusModeCapability.includes("single-shot"))) return [3 /*break*/, 4];
                        if (!(focusModeCapability.includes("continuous") && focusModeCapability.includes("manual"))) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.triggerManualFocusForContinuous()];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2:
                        if (!!focusModeCapability.includes("continuous")) return [3 /*break*/, 4];
